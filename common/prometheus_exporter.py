    ...
    def collect(self):
        ...
        if runner and runner.state in (locust_runners.STATE_SPAWNING, locust_runners.STATE_RUNNING):
            ...
            if is_distributed:
                ...
                #排除missing状态的client-workers统计
                metric.add_sample('locust_slave_count', value=len(runner.clients.ready + runner.clients.running + runner.clients.spawning), labels={})
                yield metric
...
if __name__=="__main__":
    ...
    os.system("locust  --master --web-host=0.0.0.0 --host=https://pxxapi-*.zzpxx.com -f %s" % p)
    #os.system("locust --master -f F:\pyproject\happyPerf\common\prometheus_exporter.py  --web-host=0.0.0.0 --host=https://pxxapi-uat.zzpxx.com" )